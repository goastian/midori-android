...
package org.midorinext.android.lintrules.perf
...
private const val MIDORI_PREFIX = "org.midorinext.android"
...
private val CUSTOM_VIEW_ELEMENTS = setOf(
    "$MIDORI_PREFIX.library.LibrarySiteItemView",
    "$MIDORI_PREFIX.settings.deletebrowsingdata.DeleteBrowsingDataItem",
    "$MIDORI_PREFIX.trackingprotection.SwitchWithDescription",
    "$MIDORI_PREFIX.trackingprotection.TrackingProtectionCategoryItem",
