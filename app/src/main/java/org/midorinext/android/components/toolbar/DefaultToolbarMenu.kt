...
import org.midorinext.android.components.accounts.MidoriAccountManager
 ...
 * @param hasAccountProblem If true, there was a problem signing into the Midori account.
...
open class DefaultToolbarMenu(
    ...
    private val accountManager = MidoriAccountManager(context)
