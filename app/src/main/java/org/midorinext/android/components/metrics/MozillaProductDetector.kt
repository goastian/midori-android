...
package org.midorinext.android.components.metrics

import android.content.Context
import android.content.pm.PackageManager
import org.midorinext.android.utils.BrowsersCache

// TODO: [Midori] Do we need this class?
object MozillaProductDetector {
    ...
    // Note: we intentionally do not use a-c `midoriBrandedBrowser` as this only gives us the first from that list
