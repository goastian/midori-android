...
import org.midorinext.android.compose.cfr.CFRPopup
import org.midorinext.android.compose.cfr.CFRPopup.PopupAlignment.INDICATOR_CENTERED_IN_ANCHOR
import org.midorinext.android.compose.cfr.CFRPopupProperties
import org.midorinext.android.ext.components
import org.midorinext.android.settings.SupportUtils
import org.midorinext.android.settings.SupportUtils.SumoTopic.TOTAL_COOKIE_PROTECTION
    ...
    internal fun showTcpCfr() {
        CFRPopup(
            ...
            Text(
                ...
                style = MidoriTheme.typography.body2.copy(
