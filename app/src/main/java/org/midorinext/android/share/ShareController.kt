 ...
 * @param snackbar - instance of [MidoriSnackbar] for displaying styled snackbars
...
class DefaultShareController(
    ...
    private val snackbar: MidoriSnackbar,
    private val navController: NavController,
    private val recentAppsStorage: RecentAppsStorage,
    private val viewLifecycleScope: CoroutineScope,
    private val dispatcher: CoroutineDispatcher = Dispatchers.IO,
    private val fxaEntrypoint: FxAEntryPoint = MidoriFxAEntryPoint.ShareMenu,
        ...
        val result = try {
            ...
            when (e) {
                is SecurityException, is ActivityNotFoundException -> {
                    ...
                    snackbar.setLength(MidoriSnackbar.LENGTH_LONG)
                    snackbar.show()
    ...
    private fun copyClipboard() {
        ...
        snackbar.setLength(MidoriSnackbar.LENGTH_SHORT)
        snackbar.show()
    }

    companion object {
        const val ACTION_COPY_LINK_TO_CLIPBOARD = "org.midorinext.android.COPY_LINK_TO_CLIPBOARD"
    }
}
