...
private val midori_features = arrayOf(
    "screenshots", "js", "leaf", "stackwalk", "cpu", "java",
    "processcpu", "ipcmessages", "java"
)
private val midori_threads = arrayOf(
...
enum class ProfilerSettings(val threads: Array<String>, val features: Array<String>) {
    Midori(midori_threads, midori_features),
...
object ProfilerUtils {
    ...
    /**
     * This will either save the profile locally or send it as a URL to the Midori profiler server
     *
