...
object Performance {
     ...
     * tries to leverage this intent to trigger a code path for Midori that shouldn't be used unless
     * it is for testing visual metrics. These checks aren't full proof but most of our users won't have
     * ADB on and charging at the same time when running Midori.
     */
    ...
    private fun disableOnboarding(context: Context) {
        MidoriOnboarding(context).finish()
    }
