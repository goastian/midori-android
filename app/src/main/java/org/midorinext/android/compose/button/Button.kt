...
package org.midorinext.android.compose.button
...
fun Button(
    ...
    androidx.compose.material.Button(
        ...
        Text(
            text = text,
            color = textColor,
            style = MidoriTheme.typography.button,
            maxLines = 1,
        )
    }
}
...
fun PrimaryButton(
    ...
    Button(
        text = text,
        textColor = MidoriTheme.colors.textActionPrimary,
        backgroundColor = MidoriTheme.colors.actionPrimary,
        icon = icon,
        tint = MidoriTheme.colors.iconActionPrimary,
        onClick = onClick,
    )
}
...
fun SecondaryButton(
    ...
    Button(
        ...
        backgroundColor = MidoriTheme.colors.actionSecondary,
        icon = icon,
...
fun TertiaryButton(
    ...
    Button(
        text = text,
        textColor = MidoriTheme.colors.textActionTertiary,
        backgroundColor = MidoriTheme.colors.actionTertiary,
        icon = icon,
        tint = MidoriTheme.colors.iconActionTertiary,
        onClick = onClick,
    )
}
...
fun DestructiveButton(
    ...
    Button(
        text = text,
        textColor = MidoriTheme.colors.textWarningButton,
        backgroundColor = MidoriTheme.colors.actionSecondary,
        icon = icon,
        tint = MidoriTheme.colors.iconWarningButton,
        onClick = onClick,
    )
}
