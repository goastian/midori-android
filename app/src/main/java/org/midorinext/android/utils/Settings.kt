...
import org.midorinext.android.components.metrics.MozillaProductDetector
import org.midorinext.android.components.settings.counterPreference
...
import org.midorinext.android.settings.deletebrowsingdata.DeleteBrowsingDataOnQuitType
import org.midorinext.android.settings.logins.SavedLoginsSortingStrategyMenu
import org.midorinext.android.settings.logins.SortingStrategy
import org.midorinext.android.settings.registerOnSharedPreferenceChangeListener
import org.midorinext.android.settings.sitepermissions.AUTOPLAY_BLOCK_ALL
import org.midorinext.android.settings.sitepermissions.AUTOPLAY_BLOCK_AUDIBLE
...
class Settings(private val appContext: Context) : PreferencesHolder {
    ...
    companion object {
        const val MIDORI_PREFERENCES = "midori_preferences"
    ...
    override val preferences: SharedPreferences =
        appContext.getSharedPreferences(MIDORI_PREFERENCES, MODE_PRIVATE)
    ...
    /**
     * Indicates if the Midori logo on the home screen should be animated,
     * to show users that they can change the wallpaper by tapping on the Midori logo.
     */
    var shouldAnimateMidoriLogo by booleanPreference(
     ...
     */
    fun checkIfMidoriIsDefaultBrowserOnAppResume(): Boolean {
