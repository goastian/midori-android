 ...
 * @param message A message displayed as part of [MidoriSnackbar].
 * @param undoActionTitle Label for the action associated with the [MidoriSnackbar].
 * @param onCancel A suspend block to execute in case of cancellation.
 * @param operation A suspend block to execute if user doesn't cancel via the displayed [MidoriSnackbar].
 * @param anchorView A [View] to which [MidoriSnackbar] should be anchored.
 */
...
fun CoroutineScope.allowUndo(
    ...
    fun showUndoSnackbar() {
        val snackbar = MidoriSnackbar
            .make(
                view = view,
                duration = MidoriSnackbar.LENGTH_INDEFINITE,
