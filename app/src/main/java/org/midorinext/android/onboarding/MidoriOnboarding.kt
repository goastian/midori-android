...
class MidoriOnboarding(context: Context) : PreferencesHolder {
    ...
    companion object {
         ...
         */
        private const val PREF_NAME_ONBOARDING_KEY = "midori.onboarding"

        /**
         * Key for [onboardedVersion].
         */
        @VisibleForTesting
        internal const val LAST_VERSION_ONBOARDING_KEY = "midori.onboarding.last_version"
    }
}
