...
package org.midorinext.android.settings.autofill
...
import org.midorinext.android.settings.SharedPreferenceUpdater
import org.midorinext.android.settings.SyncPreferenceView
import org.midorinext.android.settings.biometric.BiometricPromptPreferenceFragment
        ...
        SyncPreferenceView(
            ...
            onSignInToSyncClicked = {
                findNavController().navigate(
                    NavGraphDirections.actionGlobalTurnOnSync(entrypoint = MidoriFxAEntryPoint.AutofillSetting),
                )
            },
            onReconnectClicked = {
                findNavController().navigate(
                    AutofillSettingFragmentDirections.actionGlobalAccountProblemFragment(
                        entrypoint = MidoriFxAEntryPoint.AutofillSetting,
                    ),
                )
            }
        )
