...
import org.midorinext.android.databinding.FragmentAboutLibrariesBinding
import org.midorinext.android.ext.showToolbar
import java.nio.charset.Charset
import java.util.*

/**
 * Displays the licenses of all the libraries used by Midori.
 *
 * This is a re-implementation of play-services-oss-licenses library.
 * We can't use the official implementation in the OSS flavor of Midori
 ...
 * to Midori too high. Therefore, we use Google's gradle plugin to
