...
import org.midorinext.android.components.toolbar.ToolbarMenu
import org.midorinext.android.ext.components
import org.midorinext.android.ext.getStringWithArgSafe
...
class CustomTabToolbarMenu(
    ...
    private val openInMidori = SimpleBrowserMenuItem(
        label = context.getString(R.string.browser_menu_open_in_midori, appName),
        textColorResource = primaryTextColor()
    ) {
        onItemTapped.invoke(ToolbarMenu.Item.OpenInMidori)
    }
