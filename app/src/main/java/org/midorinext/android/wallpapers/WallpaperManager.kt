...
package org.midorinext.android.wallpapers
...
class WallpaperManager(
    ...
    /**
     * Animates the Midori logo, if it hasn't been animated before, otherwise nothing will happen.
     * After animating the first time, the [Settings.shouldAnimateMidoriLogo] setting
     * will be updated.
     */
    @Suppress("MagicNumber")
    fun animateLogoIfNeeded(logo: View) {
        if (!settings.shouldAnimateMidoriLogo) {
            return
        }
        Handler(Looper.getMainLooper()).postDelayed(
            {
                ...
                settings.shouldAnimateMidoriLogo = false
            },
            ANIMATION_DELAY_MS
        )
    }
    ...
    companion object {
        ...
        private val localWallpapers: List<Wallpaper.Local> = listOf(
            Wallpaper.Local.Midori("amethyst", R.drawable.amethyst),
            Wallpaper.Local.Midori("cerulean", R.drawable.cerulean),
            Wallpaper.Local.Midori("sunrise", R.drawable.sunrise),
        )
