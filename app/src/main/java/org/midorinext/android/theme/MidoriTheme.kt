...
/**
 * The theme for Midori for Android.
 *
...
object MidoriTheme {
    val colors: MidoriColors
        @Composable
        get() = localMidoriColors.current

    val typography: MidoriTypography
        get() = defaultTypography
}

private val privateColorPalette = MidoriColors(
...
/**
 * A custom Color Palette for Midori for Android.
 */
...
class MidoriColors(
    ...
    fun copy(): MidoriColors = MidoriColors(
        layer1 = layer1,
        layer2 = layer2,
        layer3 = layer3,
...
fun ProvideMidoriColors(
    ...
    CompositionLocalProvider(localMidoriColors provides colorPalette, content = content)
}

private val localMidoriColors = staticCompositionLocalOf<MidoriColors> {
    error("No MidoriColors provided")
}
