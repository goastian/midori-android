...
import org.midorinext.android.ext.containsQueryParameters
import org.midorinext.android.ext.settings
import org.midorinext.android.lifecycle.StoreLifecycleObserver
import org.midorinext.android.perf.MarkersActivityLifecycleCallbacks
import org.midorinext.android.perf.ProfilerMarkerFactProcessor
import org.midorinext.android.perf.StartupTimeline
...
import org.midorinext.android.session.PerformanceActivityLifecycleCallbacks
import org.midorinext.android.session.VisibilityLifecycleCallback
import org.midorinext.android.utils.BrowsersCache
import org.midorinext.android.utils.Settings.Companion.TOP_SITES_PROVIDER_MAX_THRESHOLD
import java.util.concurrent.TimeUnit

/**
 *The main application class for Midori. Records data to measure initialization performance.
 *  Installs [CrashReporter] and setup Megazord in the main process.
 */
@Suppress("Registered", "TooManyFunctions", "LargeClass")
open class MidoriApplication : LocaleAwareApplication(), Provider {
    init {
        recordOnInit() // DO NOT MOVE ANYTHING ABOVE HERE: the timing of this measurement is critical.
    }

    private val logger = Logger("MidoriApplication")
    ...
    open fun setupInAllProcesses() {
        ...
        Log.addSink(MidoriLogSink(logsDebug = Config.channel.isDebug))
    }
     ...
     * megazord - it contains everything that Midori needs, and (currently) nothing more.
     *
    ...
    private fun warmBrowsersCache() {
        ...
        GlobalScope.launch(Dispatchers.Default) {
            BrowsersCache.all(this@MidoriApplication)
        }
    }
