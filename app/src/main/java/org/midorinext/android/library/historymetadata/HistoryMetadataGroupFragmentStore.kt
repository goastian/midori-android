...
sealed class HistoryMetadataGroupFragmentAction : Action {
    ...
    /**
     * Updates the set of items marked for removal from the [org.midorinext.android.components.AppStore]
    ...
    /**
     * Updates the empty state of [org.midorinext.android.library.historymetadata.view.HistoryMetadataGroupView].
     */
