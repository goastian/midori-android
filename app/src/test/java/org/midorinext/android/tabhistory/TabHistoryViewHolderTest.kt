...
package org.midorinext.android.tabhistory
...
class TabHistoryViewHolderTest {
    ...
    fun `binds title and url`() {
        ...
        verify { view.setText(label = "Midori", caption = "https://astian.org") }
        verify { icons.loadIntoView(view.iconView, IconRequest("https://astian.org")) }
    }
