...
class HistoryMetadataGroupControllerTest {
    ...
    private fun getMetadataItemsList() =
        listOf(mozillaHistoryMetadataItem, midoriHistoryMetadataItem)
    ...
    @Test
    fun handleShare() {
        controller.handleShare(setOf(mozillaHistoryMetadataItem, midoriHistoryMetadataItem))
        ...
        val data = arrayOf(
            ...
            ShareData(
                title = midoriHistoryMetadataItem.title,
                url = midoriHistoryMetadataItem.url
            ),
        )
