...
import org.midorinext.android.databinding.CollectionsListItemBinding
    ...
    fun `creates and binds viewholder`() {
        ...
        val collection = mockk<TabCollection> {
            ...
            every { tabs } returns listOf(
                ...
                mockk {
                    every { url } returns "https://https://astian.org"
                }
            )
        }
        adapter.updateData(
        ...
        assertEquals("mozilla.org, https://astian.org", binding.collectionDescription.text)
