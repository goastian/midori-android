...
package org.midorinext.android.trackingprotection
...
import org.midorinext.android.trackingprotection.TrackingProtectionCategory.CRYPTOMINERS
import org.midorinext.android.trackingprotection.TrackingProtectionCategory.FINGERPRINTERS

private typealias MidoriTrackingProtectionCategory = TrackingProtectionCategory
class TrackerBucketsTest {
    ...
    fun `getter accesses corresponding bucket`() {
        ...
        assertEquals(
            facebook,
            buckets.buckets.loadedBucketMap[MidoriTrackingProtectionCategory.SOCIAL_MEDIA_TRACKERS]
            !!.first()
        )
    ...
    fun `sorts trackers into bucket`() {
        ...
        assertEquals(
            mapOf(
                MidoriTrackingProtectionCategory.SOCIAL_MEDIA_TRACKERS to listOf(facebook)
            ),
    ...
    fun `trackers in the same site but with different categories`() {
        ...
        val expectedBlockedMap =
            mapOf(
                MidoriTrackingProtectionCategory.SOCIAL_MEDIA_TRACKERS to listOf(trackerLog),
                MidoriTrackingProtectionCategory.TRACKING_CONTENT to listOf(trackerLog),
                MidoriTrackingProtectionCategory.FINGERPRINTERS to listOf(trackerLog),
                MidoriTrackingProtectionCategory.CRYPTOMINERS to listOf(trackerLog),
                MidoriTrackingProtectionCategory.CROSS_SITE_TRACKING_COOKIES to listOf(trackerLog)
            )
        val expectedLoadedMap =
            expectedBlockedMap - MidoriTrackingProtectionCategory.CROSS_SITE_TRACKING_COOKIES
