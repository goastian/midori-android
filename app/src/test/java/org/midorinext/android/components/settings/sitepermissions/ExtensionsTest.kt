...
package org.midorinext.android.components.settings.sitepermissions
...
import org.midorinext.android.settings.sitepermissions.tryReloadTabBy
...
class ExtensionsTest {
    ...
    fun `tryReloadTabBy reloads latest tab matching origin`() {
        val store = BrowserStore(
            BrowserState(
                tabs = listOf(
                    ...
                    createTab(id = "3", url = "https://astian.org")
                )
            )
        )
        ...
        components.tryReloadTabBy("https://astian.org".getOrigin()!!)
