...
import org.midorinext.android.ext.directionsEq
...
class DefaultBrowserToolbarMenuControllerTest {
    ...
    @RelaxedMockK private lateinit var openInMidoriIntent: Intent
    ...
    @RelaxedMockK private lateinit var snackbar: MidoriSnackbar
    ...
    fun setUp() {
        ...
        mockkStatic(
            "org.midorinext.android.settings.deletebrowsingdata.DeleteAndQuitKt"
        )
        every { deleteAndQuit(any(), any(), any()) } just Runs

        mockkObject(MidoriSnackbar.Companion)
        every { MidoriSnackbar.make(any(), any(), any(), any()) } returns snackbar
    ...
    @After
    fun tearDown() {
        unmockkStatic("org.midorinext.android.settings.deletebrowsingdata.DeleteAndQuitKt")
        unmockkObject(MidoriSnackbar.Companion)
    }
    ...
    @Test
    fun `WHEN open in Midori menu item is pressed THEN menu item is handled correctly`() = runTest {
        ...
        val item = ToolbarMenu.Item.OpenInMidori
        ...
        verify { activity.startActivity(openInMidoriIntent) }
