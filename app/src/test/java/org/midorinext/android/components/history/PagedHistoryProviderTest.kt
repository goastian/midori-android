...
package org.midorinext.android.components.history
...
class PagedHistoryProviderTest {
    ...
    fun `getHistory uses getVisitsPaginated`() = runTest {
        ...
        val historyMetadataKey2 = HistoryMetadataKey("http://astian.org", "mozilla", null)
        ...
        val historyMetadataKey3 = HistoryMetadataKey("http://astian.org", "mozilla", null)
    ...
    fun `redirects are filtered out from history metadata groups`() = runTest {
        ...
        val visitInfo3 = VisitInfo(
            url = "http://www.google.com/link?url=http://www.astian.org",
            title = "",
            visitTime = 1,
        ...
        val historyMetadataKey3 = HistoryMetadataKey("http://www.google.com/link?url=http://astian.org", "mozilla", null)
        val historyEntry3 = HistoryMetadata(
            key = historyMetadataKey3,
            title = "",
            createdAt = 2,
