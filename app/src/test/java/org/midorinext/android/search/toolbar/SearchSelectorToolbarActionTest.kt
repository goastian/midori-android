...
import org.midorinext.android.search.SearchDialogFragmentStore
import org.midorinext.android.search.SearchEngineSource
import org.midorinext.android.search.SearchEventSource
import org.midorinext.android.search.SearchFragmentAction.SearchDefaultEngineSelected
import org.midorinext.android.search.SearchFragmentAction.SearchHistoryEngineSelected
...
class SearchSelectorToolbarActionTest {
    ...
    fun `GIVEN a binded search selector View WHEN a search engine is selected THEN update the icon`() {
        mockkStatic("org.midorinext.android.search.toolbar.SearchSelectorToolbarActionKt") {
