...
import org.midorinext.android.helpers.Constants.LONG_CLICK_DURATION
import org.midorinext.android.helpers.Constants.RETRY_COUNT
import org.midorinext.android.helpers.MatcherHelper
import org.midorinext.android.helpers.SessionLoadedIdlingResource
...
import org.midorinext.android.helpers.TestHelper.waitForObjects
...
class BrowserRobot {
    ...
    fun verifyRateOnGooglePlayURL() {
        verifyUrl("play.google.com/store/apps/details?id=org.midorinext.android")
    }
