...
import org.midorinext.android.helpers.Constants.LISTS_MAXSWIPES
...
import org.midorinext.android.helpers.TestHelper.scrollToElementByText
import org.midorinext.android.helpers.click
import org.midorinext.android.helpers.ext.waitNotNull
import org.midorinext.android.helpers.matchers.hasItem
import org.midorinext.android.helpers.withBitmapDrawable
import org.midorinext.android.ui.util.STRING_ONBOARDING_ACCOUNT_SIGN_IN_HEADER
import org.midorinext.android.ui.util.STRING_ONBOARDING_TOOLBAR_PLACEMENT_HEADER
import org.midorinext.android.ui.util.STRING_ONBOARDING_TRACKING_PROTECTION_HEADER
...
class HomeScreenRobot {
    ...
    fun clickMidoriLogo() = homepageWordmark.click()
...
private fun assertYourPrivacyText() {
    ...
    onView(
        allOf(
            withText(
                "Midori gives you control over what you share online and what you share with us."
            )
        )
    )
        .check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
