...
import org.midorinext.android.ext.waitAndInteract
...
import org.midorinext.android.helpers.TestHelper.assertUIObjectExists
import org.midorinext.android.helpers.TestHelper.getStringResource
import org.midorinext.android.helpers.TestHelper.itemWithResId
import org.midorinext.android.helpers.TestHelper.itemWithResIdContainingText
...
class AddonsManagerRobot {
    ...
    fun dismissAddonDownloadCompletedPrompt(addonName: String) {
        ...
        mDevice
            .findObject(UiSelector().text("$addonName has been added to Midori Browser"))
