...
class NavigationToolbarRobot {
    ...
    class Transition {
        ...
        fun visitLinkFromClipboard(interact: BrowserRobot.() -> Unit): BrowserRobot.Transition {
            mDevice.waitNotNull(
                Until.findObject(By.res("org.midorinext.android.debug:id/mozac_browser_toolbar_clear_view")),
                waitingTime
            )
            clearAddressBar().click()

            mDevice.waitNotNull(
                Until.findObject(By.res("org.midorinext.android.debug:id/clipboard_title")),
                waitingTime
            )
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S) {
                mDevice.waitNotNull(
                    Until.findObject(By.res("org.midorinext.android.debug:id/clipboard_url")),
                    waitingTime
                )
            }
