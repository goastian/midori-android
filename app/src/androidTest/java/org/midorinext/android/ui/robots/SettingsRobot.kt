...
import org.midorinext.android.helpers.TestHelper.hasCousin
import org.midorinext.android.helpers.TestHelper.isPackageInstalled
...
import org.midorinext.android.ui.robots.SettingsRobot.Companion.DEFAULT_APPS_SETTINGS_ACTION
...
class SettingsRobot {
    ...
    fun verifyAboutMidoriPreview() = assertTrue(aboutMidoriHeading().waitForExists(waitingTime))
    ...
    class Transition {
        ...
        fun openAboutMidoriPreview(interact: SettingsSubMenuAboutRobot.() -> Unit):
            SettingsSubMenuAboutRobot.Transition {

            aboutMidoriHeading().click()
...
private fun aboutMidoriHeading(): UiObject {
    settingsList().scrollToEnd(LISTS_MAXSWIPES)
