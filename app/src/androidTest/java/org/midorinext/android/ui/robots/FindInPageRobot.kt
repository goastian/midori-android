...
class FindInPageRobot {
    ...
    fun enterFindInPageQuery(expectedText: String) {
        mDevice.waitNotNull(Until.findObject(By.res("org.midorinext.android.debug:id/find_in_page_query_text")), waitingTime)
        findInPageQuery().perform(clearText())
        mDevice.waitNotNull(Until.gone(By.res("org.midorinext.android.debug:id/find_in_page_result_text")), waitingTime)
        findInPageQuery().perform(typeText(expectedText))
        mDevice.waitNotNull(Until.findObject(By.res("org.midorinext.android.debug:id/find_in_page_result_text")), waitingTime)
    }
