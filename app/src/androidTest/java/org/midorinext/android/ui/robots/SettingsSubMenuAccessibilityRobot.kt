...
import org.midorinext.android.helpers.assertIsEnabled
import org.midorinext.android.helpers.isEnabled
import org.midorinext.android.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.DECIMAL_CONVERSION
import org.midorinext.android.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.MIN_VALUE
import org.midorinext.android.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.STEP_SIZE
import org.midorinext.android.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.TEXT_SIZE
...
//    onView(withId(org.midorinext.android.R.id.sampleText))
//        .check(matches(withText("This is sample text. It is here to show how text will appear when you increase or decrease the size with this setting.")))
    ...
    onView(withId(org.midorinext.android.R.id.seekbar_value))
        .check(matches(withText("100%")))

    onView(withId(org.midorinext.android.R.id.seekbar))
        .check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
}
...
//    onView(withId(org.midorinext.android.R.id.sampleText)).assertIsEnabled(false)

    onView(withId(org.midorinext.android.R.id.seekbar_value)).assertIsEnabled(false)

    onView(withId(org.midorinext.android.R.id.seekbar)).assertIsEnabled(false)
}
