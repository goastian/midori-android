...
class GradlewBuild(object):
    ...
    def test(self, identifier):
        ...
        os.chdir('../../../../../../../..')
        cmd = './gradlew ' + 'app:connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=org.midorinext.android.syncintegration.SyncIntegrationTest#{}'.format(identifier)
